    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-surface-2 to-brand-50 dark:from-surface-dark dark:to-surface-dark-2 p-4 transition-colors duration-200">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-5">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-brand-500 shadow-card-md mb-4">
        ...
        {/* Card */}
        <div className="card-premium p-5 sm:p-5">
        ...
        <p className="mt-6 text-center text-[10px] font-bold uppercase tracking-widest text-content-subtle dark:text-content-dark-muted">
          Sistema de Punto de Venta · v3.1
        </p>
      </div>
    </div>
  );
