...
export default function LoginScreen({ onLogin }) {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-surface-2 dark:bg-surface-dark text-content">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.02),transparent_24%)] dark:bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.06),transparent_24%)]" />
          ...
          <div className="space-y-5">
            <div className="space-y-1.5">
                ...
                <div className="relative group/input">
                    ...
                    <input 
                        className="input h-11 pl-10 pr-4 text-[12px]"
            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group/input">
                    ...
                    <input 
                        className="input h-11 pl-10 pr-10 text-[12px]"
