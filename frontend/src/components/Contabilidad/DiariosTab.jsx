...
export default function DiariosTab({
 ...
 <div className="w-10 rounded-xl bg-info/10 text-info flex items-center justify-center text-xl"></div>
 <div>
 <div className="text-[11px] font-black text-content-subtle uppercase tracking-wide">GESTIÓN CONTABLE</div>
 <div className="text-xs font-black text-content dark:text-content-dark">Diarios y Cajas de Cobro</div>
 </div>
 </div>
 {can("config") && (
 <button
 ...
 <div className="text-xs font-black uppercase tracking-wide text-content-muted">No hay diarios configurados</div>
 </div>
 ) : (
 ...
 <th className="text-left px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Nombre del Diario</th>
 <th className="text-left px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Método</th>
 <th className="text-left px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Banco / Entidad</th>
 <th className="text-center px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Moneda</th>
 ...
 <td className="px-4 py-2.5 text-center">
 <span className={`px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wide border ${j.active ? 'bg-success/5 text-success border-success/20' : 'bg-danger/5 text-danger border-danger/20'}`}>
