          ...
          <div className={[
            ...
            {canConfig && (
             ...
             <button onClick={() => setExpandSerie(expandSerie===serie.id ? null : serie.id)}
              className="px-5 py-2.5 rounded-xl bg-info/10 text-info border border-info/20 hover:bg-info hover:text-white transition-all font-black uppercase text-[10px] tracking-widest shadow-sm flex items-center gap-2">
