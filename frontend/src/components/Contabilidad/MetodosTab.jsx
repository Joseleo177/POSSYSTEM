...
export default function MetodosTab({ 
 ...
 <div className="w-10 rounded-xl bg-success/10 text-success flex items-center justify-center font-bold">M</div>
 <div>
 <div className="text-[11px] font-black text-content-subtle uppercase tracking-wide">CONFIGURACIÓN DE COBRO</div>
 <div className="text-xs font-black text-content dark:text-content-dark">Métodos de Pago Autorizados</div>
 </div>
 </div>
 {can("config") && (
 <button 
 ...
 <div className="text-xs font-black uppercase tracking-wide text-content-muted">Sin métodos configurados</div>
 </div>
 ) : (
 ...
 <th className="text-left px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Identificador</th>
 <th className="text-left px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Código Interno</th>
 <th className="text-center px-4 py-2.5 font-black text-content-subtle uppercase tracking-wider text-xs">Uso Global</th>
 ...
 className="w-10 p-1 bg-white border-2 border-border/40 rounded-xl cursor-pointer" 
 />
 ) : (
 ...
 <td className="px-4 py-2 text-center">
 <span className={`px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wide border ${m.active ? 'bg-success/5 text-success border-success/20' : 'bg-danger/5 text-danger border-danger/20'}`}>
 ...
 <div className="text-[11px] font-black text-content-subtle uppercase tracking-wide mb-2 ml-1">Nombre Público</div>
 <input 
 value={methodForm.name} 
 onChange={e => setMethodForm(p => ({...p, name: e.target.value}))} 
 ...
 <div className="text-[11px] font-black text-content-subtle uppercase tracking-wide mb-2 ml-1">Código Interno (Inmutable)</div>
 <input 
 ...
 <div className="col-span-2">
 <div className="text-[11px] font-black text-content-subtle uppercase tracking-wide mb-2 ml-1">Color de Marca</div>
 <div className="flex items-center gap-4">
 <input 
 type="color" value={methodForm.color} 
 onChange={e => setMethodForm(p => ({...p, color: e.target.value}))}
 className="w-16 p-1 bg-white dark:bg-surface-dark border-2 border-border/40 rounded-xl cursor-pointer" 
 />
 <div className="text-[11px] font-bold text-content-subtle opacity-60 uppercase">Este color se usará en reportes y gráficos dinámicos</div>
 </div>
 </div>
 </div>
