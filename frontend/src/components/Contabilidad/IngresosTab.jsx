                  ...
                  return (
                    <div key={bank} className="group bg-white dark:bg-surface-dark-3 rounded-[2rem] p-7 border border-border/80 dark:border-border-dark shadow-sm hover:shadow-card-lg transition-all duration-300">
                      <div className="flex items-center gap-4 mb-6">
                        <div className="w-12 h-12 rounded-2xl bg-info/10 text-info flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner">
                      ...
                      <div className="p-5 bg-surface-3/50 dark:bg-white/5 rounded-2xl mb-6 border border-border/20 dark:border-white/5 shadow-inner">
                        <div className="text-[10px] font-black text-content-subtle uppercase tracking-widest mb-4 ml-1 opacity-60">Cuentas vinculadas</div>
                        <div className="flex flex-wrap gap-2.5">
                          {d.journals.map(j => (
                            <span key={j.id} className="px-3.5 py-1.5 bg-white dark:bg-surface-dark-2 text-[10px] font-black text-content dark:text-content-dark rounded-xl border border-border dark:border-border-dark shadow-sm">
                              {j.name}
                            </span>
                          ))}
                        </div>
                ...
                {entries.map(([serie, d]) => (
                  <div key={serie} className="group bg-white dark:bg-surface-dark-3 border border-brand-500/20 rounded-3xl p-6 shadow-sm hover:shadow-card-md transition-all duration-300 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-125 transition-transform pointer-events-none">
                      <svg className="w-10 h-10 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" /></svg>
                    </div>
                    ...
                    <div className="flex items-center gap-3 py-2.5 px-4 bg-white dark:bg-surface-dark-3 rounded-2xl w-fit shadow-sm border border-border/40">
