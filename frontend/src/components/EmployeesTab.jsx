...
export default function EmployeesTab({ notify }) {
 ...
 <div>
 <div className="text-[11px] font-black text-brand-500 uppercase tracking-wide leading-none mb-0.5">MÓDULO DE PERSONAL</div>
 ...
 <button onClick={openNew} className="px-3 py-1.5 bg-brand-500 text-black rounded-lg text-[11px] font-black uppercase tracking-wide hover:bg-brand-400 transition-all active:scale-95 shrink-0">
 + Nuevo Empleado
 </button>
 </div>
 ...
 <thead>
 <tr className="border-b border-border/40 bg-surface-2 dark:bg-surface-dark-2 text-[11px] font-black text-content-muted dark:text-white/30 uppercase tracking-wide sticky top-0">
 ...
 <td className="px-6 py-5">
 <span className={`px-3 py-1 rounded-lg text-[11px] font-black uppercase tracking-wide border ${ROLE_BADGE[e.role_name] ? "bg-surface-2 dark:bg-white/5 border-border/20" : "bg-surface-1 dark:bg-white/5"}`}>
 {e.role_label}
 </span>
 </td>
 <td className="px-6 py-5">
 ...
 <td className="px-6 py-5">
 <span className={[
 "px-2.5 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wide border",
 e.active
 ...
 <button
 onClick={() => openEdit(e)}
 className="w-10 rounded-xl bg-orange-500/10 text-orange-500 border border-orange-500/20 hover:bg-orange-500 hover:text-white transition-all active:scale-90 flex items-center justify-center"
 title="Modificar"
 >
 ...
 className="w-10 rounded-xl bg-danger/10 text-danger border border-danger/20 hover:bg-danger hover:text-white transition-all active:scale-90 flex items-center justify-center"
 ...
 className="input bg-white dark:bg-surface-dark-2"
 >
