  ...
  return (
    <div onClick={onClose}
      ...
      <div onClick={e => e.stopPropagation()}
        className="bg-white dark:bg-surface-dark-2 border border-border dark:border-white/5 rounded-2xl shadow-2xl w-full overflow-y-auto animate-in zoom-in-95 slide-in-from-bottom-4 duration-300 ease-out"
        style={{ maxWidth: width, maxHeight: "92vh" }}>

        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-border/40 dark:border-white/5 sticky top-0 bg-white/80 dark:bg-surface-dark-2/80 backdrop-blur-xl z-20">
