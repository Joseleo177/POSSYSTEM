                                        ...
                                        <button
                                            ...
                                            className={`w-6 h-6 shrink-0 rounded-md border flex items-center justify-center transition-all ${
                                                checkedIds.includes(sale.id)
                                                    ...
                                                    : "border-content-subtle/50 bg-surface-3 dark:border-white/20 dark:bg-white/5 text-transparent"
                                            } disabled:opacity-20`}
                                        >
                                        ...
                                        <td className="pl-4 pr-1 py-3">
                                            <button
                                                ...
                                                className={`w-5 h-5 rounded-md border flex items-center justify-center transition-all ${
                                                    checkedIds.includes(sale.id)
                                                        ? "bg-success border-success text-black"
                                                        : "border-content-subtle/50 bg-surface-3 dark:border-white/20 dark:bg-white/5 text-transparent hover:border-success/60"
                                                } disabled:opacity-20 disabled:cursor-not-allowed disabled:hover:border-content-subtle/50`}
                                            >
