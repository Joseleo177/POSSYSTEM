...
export default function StockView({ selectedWarehouse, stockSearch, setStockSearch, loadingStock, filteredStock, handleEditStock, handleDeleteStock, openAddStock }) {
