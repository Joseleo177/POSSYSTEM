...
export default function SettingsTab({ notify }) {
 ...
 <div>
 <div className="text-[11px] font-black text-brand-500 uppercase tracking-wide leading-none mb-0.5">MÓDULO DE SISTEMA</div>
 ...
 {settings.logo_url && (
 <img src={settings.logo_url} alt="logo" className=" mx-auto mb-2 object-contain" />
 )}
 ...
 {/* Add currency card */}
 <div className="card-md p-4">
 <div className="text-xs font-bold text-warning uppercase tracking-wide mb-3.5">
 + AGREGAR MONEDA
 </div>
 ...
 <button onClick={addCurrency} className="btn-sm btn-primary whitespace-nowrap lg:">
 Agregar
 </button>
 </div>
 </div>
