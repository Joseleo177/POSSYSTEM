// Acceso directo al WhatsApp de la tienda. Se oculta mientras haya un panel abierto, para no
// quedar flotando por encima de un modal.
export default function StoreWhatsAppButton({ store, hidden }) {
    if (hidden || !store?.whatsapp) return null;
