...
export default function InventoryReport() {
 ...
 className="bg-surface-3 dark:bg-white/5 border border-border dark:border-white/5 text-[11px] font-black uppercase rounded-lg p-1.5 outline-none text-content dark:text-white w-32"
 >
 ...
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-right">Stock</th>
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-right">Mínimo</th>
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-right">Faltante</th>
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-center">Estado</th>
 </tr>
 )}
 {view === "category" && (
 <tr className="border-b border-border/40 dark:border-white/5">
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted">Categoría</th>
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-right">Surtido</th>
 <th className="px-4 py-2 text-[11px] font-black uppercase tracking-wide text-content-muted dark:text-content-dark-muted text-right">Unidades</th>
 ...
 {(view === "top" || view === "slow" || view === "zero") && <div className="p-10 text-center text-[11px] font-black uppercase text-content-subtle opacity-30 tracking-wide">Análisis Detallado en el Excel Estratégico</div>}
 </div>
 </Card>
 </div>
 )}
