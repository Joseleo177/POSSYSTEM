...
const { sanitizeDate, dateClause, DISPATCHED_SQL } = require("./shared");

async function auditReport({ date_from, date_to, limit, company_id, tcS, rep, wh, allowedWarehouses, warehouse_id }) {
