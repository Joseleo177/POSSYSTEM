...
module.exports = {
  createReturn: wrap(async req => {
    const result = await createReturn({ saleId: parseInt(req.params.id), items: req.body.items, reason: req.body.reason, refund: req.body.refund, employee_id: req.employee?.id ?? null }, req);
